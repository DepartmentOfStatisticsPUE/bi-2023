...
obciazenie <- c(mean(y_naive), mean(y_ps)) -mean(Y)
wariancja <- c(var(y_naive), var(y_ps))
rmse <- c(sqrt(obciazenie^2+wariancja))
data.frame(estymator=c("naiwny", "poststratyfikacyjny"), oszacowanie, obciazenie, wariancja, rmse)
```
